...
import 'views/viewCamera.dart';
import 'views/viewStatus.dart';
import 'views/viewCall.dart';

class HomeChat extends StatefulWidget {
  @override
  HomeChatState createState() => new HomeChatState();
}

class HomeChatState extends State<HomeChat> with SingleTickerProviderStateMixin {
